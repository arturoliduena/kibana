                    ...
                    <>
                      <EuiPanel paddingSize="m" hasShadow={false} color="subdued">
                        <EuiFlexGroup>
                          ...
                          <EuiFlexItem grow>
                            <EuiText size="xs">
                              <h3>This shared conversation was generated by an alert connector.</h3>
                              <p>
                                To interact with previous messages or send new ones, you must first
                                duplicate it into a new conversation. The original conversation will
                                remain unchanged.
                              </p>
                              <EuiButton onClick={handleForkConversation} iconType="branch">
