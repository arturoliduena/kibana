                  ...
                  {isSystem ? (
                    <EuiPanel paddingSize="m" hasShadow={false} color="primary">
                      <EuiFlexGroup>
                        ...
                        <EuiFlexItem grow>
                          <EuiText>
                            <h5>This shared conversation was generated by an alert connector.</h5>
                            <p>
                              Any interaction with pre-existent messages or attempts of sending new
                              messages will fork this conversation into a new private one. The
